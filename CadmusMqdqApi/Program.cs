    ...
    public sealed class Program
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.Console()
#if DEBUG
                .WriteTo.File("cadmus-mqdq-log.txt", rollingInterval: RollingInterval.Day)
#endif
                .CreateLogger();

            try
            {
                Log.Information("Starting Cadmus MQDQ API host");
                DumpEnvironmentVars();
            ...
            {
                Log.Fatal(ex, "Cadmus MQDQ API host terminated unexpectedly");
